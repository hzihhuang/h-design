...
function useMasonryResize ({
  ...
  const resizeCallback: ResizeCallback = useCallback((item) => handleChangeCol(Math.floor(item.contentRect.width / (currentItemMinWidth + gap))), [currentItemMinWidth, gap, handleChangeCol]);
